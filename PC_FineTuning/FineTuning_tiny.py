...
training_args = Seq2SeqTrainingArguments(
    output_dir="HuangJordan/whisper-tiny-chinese-cer",  # change to a repo name of your choice
...
kwargs = {
    ...
    "language": "zh",
    "model_name": "Whisper tiny mozilla-foundation/common_voice_11_0 - Huang Jordan",  # a 'pretty' name for our model
