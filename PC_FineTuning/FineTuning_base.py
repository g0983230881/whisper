...
training_args = Seq2SeqTrainingArguments(
    output_dir="HuangJordan/whisper-base-chinese-cer",  # change to a repo name of your choice
...
kwargs = {
    ...
    "language": "zh",
    "model_name": "Whisper base mozilla-foundation/common_voice_11_0 - Huang Jordan",  # a 'pretty' name for our model
